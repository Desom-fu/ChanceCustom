...
listRegTotalFun = [
    ...
    [
        '输入流',
        ['标识类型', '最大时间', '最大次数', '单Q次数', '是否继续匹配', '回调函数'],
        ChanceCustom.replyContent.flowInputFunTemp(),
    ],
    ...
    [
        '分割排序',
        ['排序文本', '分割符号', '依据序号', '排序正逆'],
        ChanceCustom.replyEval.splitSortFunTemp(type='split'),
    ],
    ...
    [
        '文本-中间替换',
        ['被取文本', '左边文本', '右边文本', '替换文本'],
        ChanceCustom.replyText.extractCharFunTemp(type='replace'),
    ],
    ...
    [
        '行操作-取出指定',
        ['被取文本', '开头行序', '结尾行序', '取出类型'],
        ChanceCustom.replyText.retrieveTextByLineIndexFunTemp(),
    ],
    [
        '行操作-添加文本',
        ['被添文本', '添加类型', '添加参数', '添加文本'],
        ChanceCustom.replyText.addTextForEachLineFunTemp(),
    ],
    [
        '行操作-替换文本',
        ['被替文本', '替换类型', '替换参数1', '替换参数2', '替换文本'],
        ChanceCustom.replyText.replaceTextForEachLineFunTemp(),
    ],
    # >高级文本操作<
...
listRegTotalDisEscape = [['#zzk', '【'], ['#yzk', '】'], ['#fgf', '>=<'], ['#xh', '*'], ['#hz', '||'], ['#jh', '#']]

listRegTotalEscape = [['#', '#jh'], ['||', '#hz'], ['*', '#xh'], ['>=<', '#fgf'], ['】', '#yzk'], ['【', '#zzk']]
